...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="#"><i class="fa fa-leanpub" aria-hidden="true"></i> Alx High School</a></h1>
<!-- f -->
			</div>
			...
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign  now</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#home" class="effect-3">Home</a></li>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="FA4sgmjmCyU" id="video">  <img src="https://images.unsplash.com/photo-1509099836639-18ba1795216d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1462&q=80" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>The ALX Tech Nanodegrees are a fully-funded scholarship programme providing 20,000 Tech Nanodegree programmes, powered by Udacity for African talent to enable them to become future leaders and entrepreneurs and help address the global skills gap across the tech industry. </p>
			</div> 
		</div>
	</div>
</div>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>01</h6>
				<h5>ALX Facility</h5>
				<p>Through these fully sponsored programmes, young Africans gain the skills and the connections, at no cost, to grant them access to the tech ecosystem.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Lecturers</h5>
				<p>As part of the African Leadership Group, our mission is to transform the future of Africa by creating 2M job opportunities by 2030 for young African talent.</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>Courses are online and self-paced so students can learn when and where it’s convenient for them.</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="tamiratkebede120@gmail.com"><?php echo $general_fetch['website_email1']; ?></a>
						<span><a href="tamiratkebede120@gmail.com"><?php echo $general_fetch['website_email2']; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="tamiratkebede120@gmail.com"><?php echo $general_fetch['website_email1']; ?></a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2022 ALX HIGH SCHOOL. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka</p>
	</div>
</div>
	<?php } 
	else{ ?>
	...
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="tamiratkebede120@gmail.com"><?php echo "Business Email"; ?></a>
						<span><a href="tamiratkebede120@gmail.com"><?php echo "Email 2"; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="#">Tech With KIKA</a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© - 2022 Alx High School. All rights reserved | Design by Tamirat Developed By Tamirat & Abdi</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
