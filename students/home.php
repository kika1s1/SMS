...
<head>
	<title>Augment an Admin Panel Category Flat Bootstrap Responsive Web Template</title>
...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Student</h1></span> 
